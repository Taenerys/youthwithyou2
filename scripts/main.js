...
[
  ...
  [4,"Shaking","JNERA","t"],
  [5,"Xiaotang Zhao","Mountaintop Ent.","t"],
  [6,"Babymonster An","Star Master Ent.","t"],
  [7,"Kiki Xu","SNH48","t"],
  [8,"Snow Kong","Mountaintop Ent.","t"],
  [9,"Aria Jin","Yuehua Ent.","t"],
  [10,"Lingzi Liu","OACA",""],
  [11,"NINEONE","WR/OC",""],
  [12,"Sharon Wang","TPG Culture",""],
  [13,"K Lu","TOV Ent.",""],
  [14,"Frhanm Shangquan","Star Master Ent.",""],
  [15,"Three","SNH48",""],
  [16,"Jenny Zheng","OACA",""],
  [17,"Flora Dai","Cool Young Ent.",""],
  [18,"Xinran Song","SNH48",""],
  ...
  [23,"Eliwa Xu","SNH48",""],
  [24,"Tako Zhang","SNH48",""],
  [25,"Marco Lin","TOV Ent.",""],
  [26,"JOEY CHUA","Maninquin Ent.",""],
  [27,"Bubble Zhu","Independent",""],
  [28,"Yu Zhang","D.Wang Ent.",""],
  [29,"Gia Ge","Gramarie Ent.",""],
  [30,"DDD","SNH48",""],
  [31,"Bunny Zhang","Jaywalk Newjoy",""],
  [32,"Meddhi Fu","M.Nation",""],
  [33,"Hana Lin","Good@ Media",""],
  [34,"Jue Chen","Independent",""],
  [35,"Juicy Zuo","Bymoon Ent.",""]
];
